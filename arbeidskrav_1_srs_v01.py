...
SUE = FE + DUE + BE*K + TAA  # Samlede utgifter pr aer elbil
...
SUB = FB + DUB + BB*K + TAA  # Samlede utgifter pr aer bensinbil

# %% Utskrift og sammenligning

print("Samlede utgifter pr aer bensinbil:", SUB)
print("Samlede utgifter pr aer elbil:", SUE)
